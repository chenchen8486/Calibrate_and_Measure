...
// ----------------------------------------------------------------------------
// 实现路线：OpenCV 自带检测器，零训练零模型文件——
//   二维码：cv::QRCodeDetector（detectAndDecodeMulti）；
//   一维码：cv::barcode::BarcodeDetector（detectAndDecodeWithType，EAN/UPC 系
//           可解码，Code128 等仅定位；本模块只取外接矩形，解码成功与否只影响
//           置信度）。
